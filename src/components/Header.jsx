  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-black bg-opacity-90 backdrop-blur-sm py-4 px-6 flex flex-col sm:flex-row justify-between items-center gap-4 w-full">
      <div className="contenedor-titulo">
        <h1 className="sm:text-9xl lg:text-4xl text-white drop-shadow-lg 3724-font">
      ...
      <div className="flex gap-3 lg:gap-4">
        <button 
          ...
          className={`px-4 lg:px-6 py-2 lg:py-3 rounded-sm flex items-center justify-around gap-2 transition-all font-semibold text-sm lg:text-base shadow-lg border ${
            isCartEmpty 
