...
const Gallery = forwardRef(({ onOrderChange, order, prices }, ref) => {
  ...
  <div className="w-screen min-h-dvh flex flex-col items-center justify-center px-0 overflow-hidden relative pb-4 bg-black">
        ...
        <FadeInElement className="mb-6">
          <ParallaxText speed={0.05} className="w-full">
            <div className="block sm:hidden w-full" style={{ background: '#000' }}>
              <h2 className="text-2xl sm:text-4xl 3724-font text-red-400 uppercase drop-shadow-2xl text-center w-full tracking-wide">
                COMBOS
              </h2>
            </div>
            <div className="hidden sm:block w-full">
              <h2 className="lg:text-6xl sm:text-4xl 3724-font text-red-400 uppercase drop-shadow-2xl text-center w-full tracking-wide">
                COMBOS
              </h2>
            </div>
          </ParallaxText>
  ...
  <p className="text-gray-100 text-3xl  font-extralight 3724-font text-center max-w-md shadow-none">Todos los combos incluyen papas</p>
      </div>
    </div>
  );
});
